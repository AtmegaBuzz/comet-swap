do
local _ENV = _ENV
package.preload[ "wusdc_bridge.utils.bint" ] = function( ... ) local arg = _G.arg;
...
do
local _ENV = _ENV
package.preload[ "wusdc_bridge.utils.tl-utils" ] = function( ... ) local arg = _G.arg;
...
local _tl_compat; if (tonumber((_VERSION or ''):match('[%d.]*$')) or 0) < 5.3 then local p, m = pcall(require, 'compat53.module'); if p then _tl_compat = m end end; local assert = _tl_compat and _tl_compat.assert or assert; local pairs = _tl_compat and _tl_compat.pairs or pairs; local string = _tl_compat and _tl_compat.string or string; local bint = require('wusdc_bridge.utils.bint')(256, 32)
...
Name = Name or "Ethereum-Wrapped USDC"
Ticker = Ticker or 'wUSDC'
Logo = Logo or 'VL4_2p40RKvFOQynAMilDQ4lcwjtlK3Ll-xtRhv9GSY'
